...
export default function ScheduleForm({ onSave }: ScheduleFormProps) {
  ...
  if (showSuccess && savedAppointment) {
    return (
      <div className="p-6 lg:p-8 max-w-4xl mx-auto animate-fadeIn">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 text-center animate-scaleIn">
          <div className="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-6 animate-bounceIn">
  ...
  return (
    <div className="p-6 lg:p-8 max-w-4xl mx-auto animate-fadeIn">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Submit */}
        <div className="flex gap-3 animate-slideUp" style={{ animationDelay: '400ms' }}>
          <button
            type="submit"
